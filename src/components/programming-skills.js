...
export default class ProgrammingSkills extends Component {
  ...
  listSkills(){
    const skills = [
      ...
      { "skill_name": "ReactJs", "proficiency": 75 },
      { "skill_name": "CSS", "proficiency": 90 },
      { "skill_name": "HTML", "proficiency": 70 },
      { "skill_name": "Ruby", "proficiency": 50 },
      { "skill_name": "Node Js", "proficiency": 40 },
    ];
